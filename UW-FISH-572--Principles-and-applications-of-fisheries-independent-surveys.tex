...
\begin{quote}
Last run date: Saturday, September 06, 2025
\end{quote}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{./images/FISH572-flyer.png}}

}

\caption{Course flyer}
...
\textbf{3. Survey data analysis (20\%)} \emph{DUE: 16 February}
...
(50\%)} \emph{Due: Presentation March 4-11; Paper March 13}
...
\multicolumn{1}{>{\cellcolor[HTML]{BEBEBE}\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{} & \multicolumn{1}{>{\cellcolor[HTML]{EFEFEF}\raggedright}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{Mar\ 9}}}} & \multicolumn{1}{>{\cellcolor[HTML]{EFEFEF}\raggedleft}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{}}}} & \multicolumn{1}{>{\cellcolor[HTML]{EFEFEF}\raggedright}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{\textit{Hicks\ (Markowitz)}}}}} & \multicolumn{1}{>{\cellcolor[HTML]{EFEFEF}\raggedright}m{\dimexpr 0.75in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{11}{11}\selectfont{\global\setmainfont{Arial}{\textit{Student\ Presentations}}}}} \\
...
\subsection{\texorpdfstring{\emph{Why fisheries-independent surveys are
important?}}{Why fisheries-independent surveys are important?}}\label{why-fisheries-independent-surveys-are-important}
...
\section{\texorpdfstring{\emph{Why would this course prepare you well
for the future career in the field of fisheries
science?}}{Why would this course prepare you well for the future career in the field of fisheries science?}}\label{why-would-this-course-prepare-you-well-for-the-future-career-in-the-field-of-fisheries-science}
...
\subsection{\texorpdfstring{\emph{Why learning about
fisheries-independent surveys is critical to prepare you well for future
collaboration with artificial intelligence
(AI)?}}{Why learning about fisheries-independent surveys is critical to prepare you well for future collaboration with artificial intelligence (AI)?}}\label{why-learning-about-fisheries-independent-surveys-is-critical-to-prepare-you-well-for-future-collaboration-with-artificial-intelligence-ai}
...
\subsection{\texorpdfstring{\textbf{What is the future of
fisheries-independent
surveys?}}{What is the future of fisheries-independent surveys?}}\label{what-is-the-future-of-fisheries-independent-surveys}
...
\subsection{*I'm considering a career in marine ecology. How would this
class benefit me in that
pursuit?**}\label{im-considering-a-career-in-marine-ecology.-how-would-this-class-benefit-me-in-that-pursuit}
...
\subsection{*I'm considering a career in fisheries stock assessment. How
would this class benefit me in that
pursuit?**}\label{im-considering-a-career-in-fisheries-stock-assessment.-how-would-this-class-benefit-me-in-that-pursuit}
...
\subsection{\texorpdfstring{\emph{I'm considering a career in fisheries
management. How would this class benefit me in that
pursuit?}}{I'm considering a career in fisheries management. How would this class benefit me in that pursuit?}}\label{im-considering-a-career-in-fisheries-management.-how-would-this-class-benefit-me-in-that-pursuit}
...
\subsection{\texorpdfstring{\emph{I'm considering a career in academia.
How would this class benefit me in that
pursuit?}}{I'm considering a career in academia. How would this class benefit me in that pursuit?}}\label{im-considering-a-career-in-academia.-how-would-this-class-benefit-me-in-that-pursuit}
...
\section{AFSC Grounfish Bottom Trawl Survey
Resources}\label{afsc-grounfish-bottom-trawl-survey-resources}
